...
class Accountant extends Manager implements Contracts\Accountant
{
    ...
    public function record(
        ...
        if ($this->container->make('events')->until(new Recording($model, $driver, $event, $pivotRelation, $pivotProperties)) === false) {
            return;
        }
        ...
        $this->container->make('events')->dispatch(new Recorded($model, $driver, $ledger));
    }
}
